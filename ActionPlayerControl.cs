...
public class ActionPlayerControl : MonoBehaviour
{
    ...
    private bool SelectingWeapon, CanTurn;
    ...
    void HandControls()
    {
        ...
        CC.Move(Quaternion.Euler(0, Camera.main.transform.eulerAngles.y, 0) * new Vector3(Input.HandCon.StickVector.x, -0.9f, Input.HandCon.StickVector.y) * Time.deltaTime * MoveSpeed);
